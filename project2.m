...
[fig2, img2] = snapshot(cam);

figure();
imshow(fig2)
title('Snapshot 2')

%% Figure out why we can't save the images
imwrite(fig, 'C:\Users\thema\OneDrive\Documents\SchoolStuff\Fall 2020\Senior Design\Project2\snapshot1.png')
% imfinfo('C:\Users\thema\OneDrive\Documents\SchoolStuff\Fall 2020\Senior Design\Project2\snapshot1.png')

imwrite(fig2, 'C:\Users\thema\OneDrive\Documents\SchoolStuff\Fall 2020\Senior Design\Project2\snapshot2.png')
% imfinfo('C:\Users\thema\OneDrive\Documents\SchoolStuff\Fall 2020\Senior Design\Project2\snapshot2.png')
...
%% Actual 
%Image_Orig = imread('snapshot1.png');
%Image_Background = imread('snapshot2.png');
...
% Well Colors
gameState.wellLoc = [0,0,1,0,2,0,0,4,0]; % Desired Configuration
gameState.key = {'0', 'Empty';'1', 'Red'; '2', 'Green'; '3', 'Yellow'; '4', 'Blue'};

%% Check well locations for color
...
% 
% %% Call regionprops 
% STATS = regionprops(Image_Binary, 'all')
% 
% %% Print overlay
% figure();
% imshow(Image_Orig)
